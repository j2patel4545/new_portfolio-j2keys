      ...
      >
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5 md:gap-3">
          ...
          >
            ...
            <span className="inline-flex items-center justify-center w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-zinc-900 dark:bg-zinc-800 text-white group-hover:bg-rose-600 dark:group-hover:bg-rose-500 transition-colors shadow-xs">
            ...
            >
              ...
              <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-14 items-center my-auto py-3 sm:py-6 z-20">
                ...
                >
                  ...
                  {/* Direct Contact */}
                  <div className="p-3 sm:p-4 rounded-xl bg-white dark:bg-zinc-800 border border-zinc-200/90 dark:border-zinc-700 shadow-sm space-y-1">
                    ...
                    <div className="flex flex-wrap gap-1.5 sm:gap-2">
                      {[
                        ...
                        <a
                          ...
                          className="inline-flex items-center gap-1.5 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-lg bg-white dark:bg-zinc-800 hover:bg-zinc-100 dark:hover:bg-zinc-700 border border-zinc-200/90 dark:border-zinc-700 text-[11px] sm:text-xs font-semibold text-zinc-800 dark:text-zinc-200 hover:text-zinc-950 dark:hover:text-white transition-colors shadow-xs"
                        >
